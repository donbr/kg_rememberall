...
* [eval.py](#file-eval.py)
* [RELEASE.md](#file-RELEASE.md)
* [README_Extended.md](#file-README_Extended.md)
* [convert_to_onnx.py](#file-convert_to_onnx.py)
* [custom_train.py](#file-custom_train.py)
* [data/process_pilener.py](#file-data-process_pilener.py)
* [data/process_nuner.py](#file-data-process_nuner.py)
* [examples/sample_data.json](#file-examples-sample_data.json)
* [examples/convert_to_onnx.py](#file-examples-convert_to_onnx.py)
* [examples/synthetic_data_generation.py](#file-examples-synthetic_data_generation.py)
* [examples/load_local_model.py](#file-examples-load_local_model.py)
* [examples/exal_example_conll.py](#file-examples-exal_example_conll.py)
* [examples/gliner_spacy_demo.py](#file-examples-gliner_spacy_demo.py)
* [examples/quickstart.py](#file-examples-quickstart.py)
* [examples/finetune.py](#file-examples-finetune.py)
* [configs/config_span.yaml](#file-configs-config_span.yaml)
* [configs/config_token.yaml](#file-configs-config_token.yaml)
* [configs/config.yaml](#file-configs-config.yaml)
* [configs/config_biencoder.yaml](#file-configs-config_biencoder.yaml)
* [logo/FI Group.png](#file-logo-FI Group.png)
* [logo/FI_COMPLET_CW.png](#file-logo-FI_COMPLET_CW.png)
* [gliner/__init__.py](#file-gliner-__init__.py)
* [gliner/model.py](#file-gliner-model.py)
* [gliner/utils.py](#file-gliner-utils.py)
* [gliner/config.py](#file-gliner-config.py)
* [gliner/evaluation/evaluator.py](#file-gliner-evaluation-evaluator.py)
* [gliner/evaluation/__init__.py](#file-gliner-evaluation-__init__.py)
* [gliner/evaluation/evaluate.py](#file-gliner-evaluation-evaluate.py)
* [gliner/onnx/__init__.py](#file-gliner-onnx-__init__.py)
* [gliner/onnx/model.py](#file-gliner-onnx-model.py)
* [gliner/data_processing/__init__.py](#file-gliner-data_processing-__init__.py)
* [gliner/data_processing/processor.py](#file-gliner-data_processing-processor.py)
* [gliner/data_processing/tokenizer.py](#file-gliner-data_processing-tokenizer.py)
* [gliner/data_processing/dataset.py](#file-gliner-data_processing-dataset.py)
* [gliner/data_processing/utils.py](#file-gliner-data_processing-utils.py)
* [gliner/data_processing/collator.py](#file-gliner-data_processing-collator.py)
* [gliner/modeling/__init__.py](#file-gliner-modeling-__init__.py)
* [gliner/modeling/loss_functions.py](#file-gliner-modeling-loss_functions.py)
* [gliner/modeling/span_rep.py](#file-gliner-modeling-span_rep.py)
* [gliner/modeling/base.py](#file-gliner-modeling-base.py)
* [gliner/modeling/layers.py](#file-gliner-modeling-layers.py)
* [gliner/modeling/scorers.py](#file-gliner-modeling-scorers.py)
* [gliner/modeling/encoder.py](#file-gliner-modeling-encoder.py)
* [gliner/training/__init__.py](#file-gliner-training-__init__.py)
* [gliner/training/trainer.py](#file-gliner-training-trainer.py)
* [gliner/multitask/open_extraction.py](#file-gliner-multitask-open_extraction.py)
* [gliner/multitask/classification.py](#file-gliner-multitask-classification.py)
* [gliner/multitask/question_answering.py](#file-gliner-multitask-question_answering.py)
* [gliner/multitask/__init__.py](#file-gliner-multitask-__init__.py)
* [gliner/multitask/base.py](#file-gliner-multitask-base.py)
* [gliner/multitask/summarization.py](#file-gliner-multitask-summarization.py)
* [gliner/multitask/relation_extraction.py](#file-gliner-multitask-relation_extraction.py)
* [gliner/decoding/decoder.py](#file-gliner-decoding-decoder.py)
* [gliner/decoding/__init__.py](#file-gliner-decoding-__init__.py)
* [gliner/decoding/utils.py](#file-gliner-decoding-utils.py)
* [tests/test_models.py](#file-tests-test_models.py)
* [tests/test_features_selection.py](#file-tests-test_features_selection.py)
